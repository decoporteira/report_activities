...
RSpec.describe 'User vê listagem de alunos' do
    ...
    it 'com sucesso' do
        ...
        user_teacher_two = User.create!(email: 'clara@admin.com.br', password: 'password', role: 'teacher' )
        teacher = Teacher.create!(name: 'Bianca', status: 'disponível', user_id: user_teacher.id, cpf: '087.097.098-01' )
        teacher_two = Teacher.create!(name:'Clara', status: 'disponível', user_id: user_teacher_two.id, cpf: '088.088.098-01')
