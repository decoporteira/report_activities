class CurrentPlansController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @current_plan.save
        format.html { redirect_to current_plan_url(@current_plan), notice: "Current plan was successfully created." }
  ...
  def update
    respond_to do |format|
      if @current_plan.update(current_plan_params)
        format.html { redirect_to current_plan_url(@current_plan), notice: "Current plan was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to current_plans_url, notice: "Current plan was successfully destroyed." }
